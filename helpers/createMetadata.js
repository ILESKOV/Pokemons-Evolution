...
var Pokemons = []
Pokemons[0] = 0
function createBaseStatPokemon(
    number,
    nick,
    type1,
    type2,
    ...
    var Pokemon = [number, nick, type1, type2, total, hp, attack, defense, specialAttack, specialDefense, speed]
...
createBaseStatPokemon(386, "Deoxys", "Psychic", "None", 600, 50, 150, 50, 150, 50, 150)
...
createBaseStatPokemon(413, "Wormadam", "Bug", "Grass", 424, 60, 59, 85, 79, 105, 36)
...
createBaseStatPokemon(487, "Giratina", "Ghost", "Dragon", 680, 150, 100, 120, 100, 120, 90)
...
createBaseStatPokemon(492, "Shaymin", "Grass", "None", 600, 100, 100, 100, 100, 100, 100)
...
createBaseStatPokemon(555, "Darmanitan", "Fire", "None", 480, 105, 140, 55, 30, 55, 95)
...
createBaseStatPokemon(641, "Tornadus", "Flying", "None", 580, 79, 115, 70, 125, 80, 111)
createBaseStatPokemon(642, "Thundurus", "Electric", "Flying", 580, 79, 115, 70, 125, 80, 111)
...
createBaseStatPokemon(645, "Landorus", "Ground", "Flying", 600, 89, 125, 90, 115, 80, 101)
createBaseStatPokemon(646, "Kyurem", "Dragon", "Ice", 660, 125, 130, 90, 130, 90, 95)
createBaseStatPokemon(647, "Keldeo", "Water", "Fighting", 580, 91, 72, 90, 129, 90, 108)
createBaseStatPokemon(648, "Meloetta", "Normal", "Psychic", 600, 100, 77, 77, 128, 128, 90)
...
createBaseStatPokemon(669, "Flabebe", "Fairy", "None", 303, 44, 38, 39, 61, 79, 42)
...
createBaseStatPokemon(710, "Pumpkaboo", "Ghost", "Grass", 335, 49, 66, 70, 44, 55, 51)
createBaseStatPokemon(711, "Gourgeist", "Ghost", "Grass", 494, 65, 90, 122, 58, 75, 84)
...
createBaseStatPokemon(718, "Zygarde", "Dragon", "Ground", 486, 54, 100, 71, 61, 85, 115)
createBaseStatPokemon(719, "Diancie", "Rock", "Fairy", 600, 50, 100, 150, 100, 150, 50)
createBaseStatPokemon(720, "Hoopa", "Psychic", "Ghost", 600, 80, 110, 60, 150, 130, 70)
...
createBaseStatPokemon(741, "Oricorio", "Fire", "Flying", 476, 75, 70, 70, 98, 70, 93)
...
createBaseStatPokemon(745, "Lycanroc", "Rock", "None", 487, 75, 115, 65, 55, 65, 112)
createBaseStatPokemon(746, "Wishiwashi", "Water", "None", 175, 45, 20, 20, 25, 25, 40)
...
createBaseStatPokemon(774, "Minior", "Rock", "Flying", 440, 60, 60, 100, 60, 100, 60)
...
createBaseStatPokemon(849, "Toxtricity", "Electric", "Poison", 502, 75, 98, 70, 114, 70, 75)
...
createBaseStatPokemon(875, "Eiscue", "Ice", "None", 470, 75, 80, 110, 65, 90, 50)
createBaseStatPokemon(876, "Indeedee", "Psychic", "Normal", 475, 60, 65, 55, 105, 95, 95)
createBaseStatPokemon(877, "Morpeko", "Electric", "Dark", 436, 58, 95, 58, 70, 58, 97)
...
createBaseStatPokemon(888, "Zacian", "Fairy", "None", 670, 92, 130, 115, 80, 115, 138)
createBaseStatPokemon(889, "Zamazenta", "Fighting", "None", 670, 92, 130, 115, 80, 115, 138)
...
createBaseStatPokemon(892, "Urshifu", "Fighting", "Dark", 550, 100, 130, 100, 63, 60, 97)
...
createBaseStatPokemon(899, "Wyrdeer", "Normal", "Psychic", 525, 103, 105, 72, 105, 75, 65)
createBaseStatPokemon(900, "Kleavor", "Bug", "Rock", 500, 70, 135, 95, 45, 70, 85)
createBaseStatPokemon(901, "Ursaluna", "Normal", "Ground", 550, 130, 140, 105, 45, 80, 50)
createBaseStatPokemon(902, "Basculegion", "Water", "Ghost", 530, 120, 112, 65, 80, 75, 78)
createBaseStatPokemon(903, "Sneasler", "Poison", "Fighting", 510, 80, 130, 60, 40, 80, 120)
createBaseStatPokemon(904, "Overqwil", "Dark", "Poison", 510, 85, 115, 95, 65, 65, 85)
createBaseStatPokemon(905, "Enamorus", "Fairy", "Flying", 580, 74, 115, 70, 135, 80, 106)

for (var i = 1; i <= 905; i++) {
    var json = {}
    json.name = Pokemons[i][1]
    json.external_url = "https://pokemondb.net/evolution"
    json.description = `${Pokemons[i][1]} is a ${Pokemons[i][2]}/${Pokemons[i][3]} type Pokemon`
    json.attributes = []
    json.attributes[0] = {}
    json.attributes[0].trait_type = "TYPE_1"
    json.attributes[0].value = Pokemons[i][2]
    json.attributes[1] = {}
    json.attributes[1].trait_type = "TYPE_2"
    json.attributes[1].value = Pokemons[i][3]
    json.attributes[2] = {}
    json.attributes[2].display_type = "boost_number"
    json.attributes[2].trait_type = "TOTAL"
    json.attributes[2].value = Pokemons[i][4].toString()
    json.attributes[3] = {}
    json.attributes[3].display_type = "boost_number"
    json.attributes[3].trait_type = "HP"
    json.attributes[3].value = Pokemons[i][5].toString()
    json.attributes[4] = {}
    json.attributes[4].display_type = "boost_number"
    json.attributes[4].trait_type = "ATACK"
    json.attributes[4].value = Pokemons[i][6].toString()
    json.attributes[5] = {}
    json.attributes[5].display_type = "boost_number"
    json.attributes[5].trait_type = "DEFENSE"
    json.attributes[5].value = Pokemons[i][7].toString()
    json.attributes[6] = {}
    json.attributes[6].display_type = "boost_number"
    json.attributes[6].trait_type = "SPECIAL_ATTACK"
    json.attributes[6].value = Pokemons[i][8].toString()
    json.attributes[7] = {}
    json.attributes[7].display_type = "boost_number"
    json.attributes[7].trait_type = "SPECIAL_DEFENSE"
    json.attributes[7].value = Pokemons[i][9].toString()
    json.attributes[8] = {}
    json.attributes[8].display_type = "boost_number"
    json.attributes[8].trait_type = "SPEED"
    json.attributes[8].value = Pokemons[i][10].toString()
    json.attributes[9] = {}
    json.attributes[9].display_type = "number"
    json.attributes[9].trait_type = "National №"
    json.attributes[9].value = Pokemons[i][0].toString()
    json.image = "ipfs://bafybeih3lpg2laxeqwnlgoktv3ih6idk5lbk6byi2wo7kgot44inufsmb4/" + i + ".jpg"
